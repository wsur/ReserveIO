...
namespace ReserveIO.Migrations
{
    ...
    [Migration("20240515051924_AlterUserRolesController")]
    partial class AlterUserRolesController
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ReserveIO.Models.CostHour", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 15, 10, 19, 23, 699, DateTimeKind.Local).AddTicks(4675)
                        },
                        new
                        {
                            CostId = 2,
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 15, 10, 19, 23, 699, DateTimeKind.Local).AddTicks(4685)
                        },
                        new
                        {
                            CostId = 3,
                            Cost = 2500,
                            CostRoomId = 2,
                            TimeStampTZ = new DateTime(2024, 5, 15, 10, 19, 23, 699, DateTimeKind.Local).AddTicks(4686)
                        },
                        new
                        {
                            CostId = 4,
                            Cost = 2500,
                            CostRoomId = 3,
                            TimeStampTZ = new DateTime(2024, 5, 15, 10, 19, 23, 699, DateTimeKind.Local).AddTicks(4687)
                        });
                });
            ...
            modelBuilder.Entity("ReserveIO.Models.SummaryTable", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SummaryId = 1,
                            Datetime = new DateTime(2024, 5, 15, 10, 19, 23, 705, DateTimeKind.Local).AddTicks(4803),
                        ...
                        {
                            SummaryId = 2,
                            Datetime = new DateTime(2024, 5, 15, 10, 19, 23, 705, DateTimeKind.Local).AddTicks(4898),
                        ...
                        {
                            SummaryId = 3,
                            Datetime = new DateTime(2024, 5, 15, 10, 19, 23, 705, DateTimeKind.Local).AddTicks(4905),
            ...
            modelBuilder.Entity("ReserveIO.Models.ServiceInfo", b =>
                {
                    b.HasOne("ReserveIO.Models.SummaryTable", "Reserve")
                        .WithMany()
