...
namespace ReserveIO.Migrations
{
    ...
    [Migration("20240516061830_UpdateUserRoomKeyCascade")]
    partial class UpdateUserRoomKeyCascade
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReserveIO.Models.CostHour", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 16, 11, 18, 30, 400, DateTimeKind.Local).AddTicks(5429)
                        },
                        new
                        {
                            CostId = 2,
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 16, 11, 18, 30, 400, DateTimeKind.Local).AddTicks(5438)
                        },
                        new
                        {
                            CostId = 3,
                            Cost = 2500,
                            CostRoomId = 2,
                            TimeStampTZ = new DateTime(2024, 5, 16, 11, 18, 30, 400, DateTimeKind.Local).AddTicks(5440)
                        },
                        new
                        {
                            CostId = 4,
                            Cost = 2500,
                            CostRoomId = 3,
                            TimeStampTZ = new DateTime(2024, 5, 16, 11, 18, 30, 400, DateTimeKind.Local).AddTicks(5441)
                        });
                });
            ...
            modelBuilder.Entity("ReserveIO.Models.SummaryTable", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SummaryId = 1,
                            Datetime = new DateTime(2024, 5, 16, 11, 18, 30, 404, DateTimeKind.Local).AddTicks(6244),
                        ...
                        {
                            SummaryId = 2,
                            Datetime = new DateTime(2024, 5, 16, 11, 18, 30, 404, DateTimeKind.Local).AddTicks(6401),
                        ...
                        {
                            SummaryId = 3,
                            Datetime = new DateTime(2024, 5, 16, 11, 18, 30, 404, DateTimeKind.Local).AddTicks(6410),
