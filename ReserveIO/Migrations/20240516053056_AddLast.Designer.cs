...
namespace ReserveIO.Migrations
{
    ...
    [Migration("20240516053056_AddLast")]
            ...
            modelBuilder.Entity("ReserveIO.Models.CostHour", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 16, 10, 30, 56, 317, DateTimeKind.Local).AddTicks(1081)
                        },
                        new
                        {
                            CostId = 2,
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 16, 10, 30, 56, 317, DateTimeKind.Local).AddTicks(1092)
                        },
                        new
                        {
                            CostId = 3,
                            Cost = 2500,
                            CostRoomId = 2,
                            TimeStampTZ = new DateTime(2024, 5, 16, 10, 30, 56, 317, DateTimeKind.Local).AddTicks(1094)
                        },
                        new
                        {
                            CostId = 4,
                            Cost = 2500,
                            CostRoomId = 3,
                            TimeStampTZ = new DateTime(2024, 5, 16, 10, 30, 56, 317, DateTimeKind.Local).AddTicks(1098)
                        });
                });
            ...
            modelBuilder.Entity("ReserveIO.Models.SummaryTable", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SummaryId = 1,
                            Datetime = new DateTime(2024, 5, 16, 10, 30, 56, 321, DateTimeKind.Local).AddTicks(4980),
                        ...
                        {
                            SummaryId = 2,
                            Datetime = new DateTime(2024, 5, 16, 10, 30, 56, 321, DateTimeKind.Local).AddTicks(5069),
                        ...
                        {
                            SummaryId = 3,
                            Datetime = new DateTime(2024, 5, 16, 10, 30, 56, 321, DateTimeKind.Local).AddTicks(5076),
