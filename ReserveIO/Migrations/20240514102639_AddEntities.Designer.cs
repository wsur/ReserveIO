...
namespace ReserveIO.Migrations
{
    ...
    [Migration("20240514102639_AddEntities")]
            ...
            modelBuilder.Entity("ReserveIO.Models.CostHour", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 14, 15, 26, 39, 595, DateTimeKind.Local).AddTicks(9852)
                        },
                        new
                        {
                            CostId = 2,
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 14, 15, 26, 39, 595, DateTimeKind.Local).AddTicks(9862)
                        },
                        new
                        {
                            CostId = 3,
                            Cost = 2500,
                            CostRoomId = 2,
                            TimeStampTZ = new DateTime(2024, 5, 14, 15, 26, 39, 595, DateTimeKind.Local).AddTicks(9863)
                        },
                        new
                        {
                            CostId = 4,
                            Cost = 2500,
                            CostRoomId = 3,
                            TimeStampTZ = new DateTime(2024, 5, 14, 15, 26, 39, 595, DateTimeKind.Local).AddTicks(9864)
                        });
                });
            ...
            modelBuilder.Entity("ReserveIO.Models.SummaryTable", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SummaryId = 1,
                            Datetime = new DateTime(2024, 5, 14, 15, 26, 39, 601, DateTimeKind.Local).AddTicks(8069),
                        ...
                        {
                            SummaryId = 2,
                            Datetime = new DateTime(2024, 5, 14, 15, 26, 39, 601, DateTimeKind.Local).AddTicks(8150),
                        ...
                        {
                            SummaryId = 3,
                            Datetime = new DateTime(2024, 5, 14, 15, 26, 39, 601, DateTimeKind.Local).AddTicks(8158),
