...
namespace ReserveIO.Migrations
{
    ...
    [Migration("20240516063537_UpdateRoomForeignKey")]
            ...
            modelBuilder.Entity("ReserveIO.Models.CostHour", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 16, 11, 35, 37, 222, DateTimeKind.Local).AddTicks(7159)
                        },
                        new
                        {
                            CostId = 2,
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 16, 11, 35, 37, 222, DateTimeKind.Local).AddTicks(7170)
                        },
                        new
                        {
                            CostId = 3,
                            Cost = 2500,
                            CostRoomId = 2,
                            TimeStampTZ = new DateTime(2024, 5, 16, 11, 35, 37, 222, DateTimeKind.Local).AddTicks(7171)
                        },
                        new
                        {
                            CostId = 4,
                            Cost = 2500,
                            CostRoomId = 3,
                            TimeStampTZ = new DateTime(2024, 5, 16, 11, 35, 37, 222, DateTimeKind.Local).AddTicks(7173)
                        });
                });
            ...
            modelBuilder.Entity("ReserveIO.Models.SummaryTable", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SummaryId = 1,
                            Datetime = new DateTime(2024, 5, 16, 11, 35, 37, 226, DateTimeKind.Local).AddTicks(8564),
                        ...
                        {
                            SummaryId = 2,
                            Datetime = new DateTime(2024, 5, 16, 11, 35, 37, 226, DateTimeKind.Local).AddTicks(8646),
                        ...
                        {
                            SummaryId = 3,
                            Datetime = new DateTime(2024, 5, 16, 11, 35, 37, 226, DateTimeKind.Local).AddTicks(8653),
