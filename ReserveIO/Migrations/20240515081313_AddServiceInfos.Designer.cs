...
namespace ReserveIO.Migrations
{
    ...
    [Migration("20240515081313_AddServiceInfos")]
    partial class AddServiceInfos
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReserveIO.Models.CostHour", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 15, 13, 13, 13, 280, DateTimeKind.Local).AddTicks(6602)
                        },
                        new
                        {
                            CostId = 2,
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 15, 13, 13, 13, 280, DateTimeKind.Local).AddTicks(6616)
                        },
                        new
                        {
                            CostId = 3,
                            Cost = 2500,
                            CostRoomId = 2,
                            TimeStampTZ = new DateTime(2024, 5, 15, 13, 13, 13, 280, DateTimeKind.Local).AddTicks(6617)
                        },
                        new
                        {
                            CostId = 4,
                            Cost = 2500,
                            CostRoomId = 3,
                            TimeStampTZ = new DateTime(2024, 5, 15, 13, 13, 13, 280, DateTimeKind.Local).AddTicks(6618)
                        });
                });
            ...
            modelBuilder.Entity("ReserveIO.Models.SummaryTable", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SummaryId = 1,
                            Datetime = new DateTime(2024, 5, 15, 13, 13, 13, 284, DateTimeKind.Local).AddTicks(8025),
                        ...
                        {
                            SummaryId = 2,
                            Datetime = new DateTime(2024, 5, 15, 13, 13, 13, 284, DateTimeKind.Local).AddTicks(8113),
                        ...
                        {
                            SummaryId = 3,
                            Datetime = new DateTime(2024, 5, 15, 13, 13, 13, 284, DateTimeKind.Local).AddTicks(8120),
