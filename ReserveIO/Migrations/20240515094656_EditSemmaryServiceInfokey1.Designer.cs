...
namespace ReserveIO.Migrations
{
    ...
    [Migration("20240515094656_EditSemmaryServiceInfokey1")]
    partial class EditSemmaryServiceInfokey1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReserveIO.Models.CostHour", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 15, 14, 46, 56, 444, DateTimeKind.Local).AddTicks(6973)
                        },
                        new
                        {
                            CostId = 2,
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 15, 14, 46, 56, 444, DateTimeKind.Local).AddTicks(6985)
                        },
                        new
                        {
                            CostId = 3,
                            Cost = 2500,
                            CostRoomId = 2,
                            TimeStampTZ = new DateTime(2024, 5, 15, 14, 46, 56, 444, DateTimeKind.Local).AddTicks(6986)
                        },
                        new
                        {
                            CostId = 4,
                            Cost = 2500,
                            CostRoomId = 3,
                            TimeStampTZ = new DateTime(2024, 5, 15, 14, 46, 56, 444, DateTimeKind.Local).AddTicks(6987)
                        });
                });
            ...
            modelBuilder.Entity("ReserveIO.Models.SummaryTable", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SummaryId = 1,
                            Datetime = new DateTime(2024, 5, 15, 14, 46, 56, 449, DateTimeKind.Local).AddTicks(1496),
                        ...
                        {
                            SummaryId = 2,
                            Datetime = new DateTime(2024, 5, 15, 14, 46, 56, 449, DateTimeKind.Local).AddTicks(1656),
                        ...
                        {
                            SummaryId = 3,
                            Datetime = new DateTime(2024, 5, 15, 14, 46, 56, 449, DateTimeKind.Local).AddTicks(1664),
