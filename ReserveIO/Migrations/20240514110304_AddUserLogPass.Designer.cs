...
namespace ReserveIO.Migrations
{
    ...
    [Migration("20240514110304_AddUserLogPass")]
    partial class AddUserLogPass
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ReserveIO.Models.CostHour", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 14, 16, 3, 4, 121, DateTimeKind.Local).AddTicks(1488)
                        },
                        new
                        {
                            CostId = 2,
                            Cost = 2500,
                            CostRoomId = 1,
                            TimeStampTZ = new DateTime(2024, 5, 14, 16, 3, 4, 121, DateTimeKind.Local).AddTicks(1498)
                        },
                        new
                        {
                            CostId = 3,
                            Cost = 2500,
                            CostRoomId = 2,
                            TimeStampTZ = new DateTime(2024, 5, 14, 16, 3, 4, 121, DateTimeKind.Local).AddTicks(1500)
                        },
                        new
                        {
                            CostId = 4,
                            Cost = 2500,
                            CostRoomId = 3,
                            TimeStampTZ = new DateTime(2024, 5, 14, 16, 3, 4, 121, DateTimeKind.Local).AddTicks(1501)
                        });
                });
            ...
            modelBuilder.Entity("ReserveIO.Models.SummaryTable", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SummaryId = 1,
                            Datetime = new DateTime(2024, 5, 14, 16, 3, 4, 126, DateTimeKind.Local).AddTicks(8380),
                        ...
                        {
                            SummaryId = 2,
                            Datetime = new DateTime(2024, 5, 14, 16, 3, 4, 126, DateTimeKind.Local).AddTicks(8464),
                        ...
                        {
                            SummaryId = 3,
                            Datetime = new DateTime(2024, 5, 14, 16, 3, 4, 126, DateTimeKind.Local).AddTicks(8472),
